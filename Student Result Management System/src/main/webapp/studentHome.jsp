...
try {
	...
	"select * from student1 inner join resultdata where student1.rollNumber=resultdata.rollNumber and student1.rollNumber='"
			+ rollNumber + "'");
	if (rs.next()) {
%>
...
<center>
	<img src="sp.png" width="150" height="150"> <img
...
<body>
	...
	<center>
		<h6>Note: Institution doesn't own for the errors or omissions, if
			any, in this statement contact to harshad</h6>
	</center>
	<hr class="new1">
	<center>
		<h6>All Right Be with Harshad</h6>
	</center>
	<hr class="new1">
</body>
<%
